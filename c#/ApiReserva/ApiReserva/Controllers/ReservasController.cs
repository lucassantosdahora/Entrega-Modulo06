...
namespace ApiReserva.Controllers
{
    ...
    public class ReservasController : ControllerBase
    {
        ...
        public async Task<ActionResult<Reserva>> PostReserva(Reserva reserva)
        {
            ...
            Destino destinoExistente = await _context.Destinos.FindAsync(reserva.DestinoId);

            if (destinoExistente == null)
            {
               
                return BadRequest("O destino especificado não existe.");
            }
            ...
            // Retornar a reserva criada com o ID do destino
